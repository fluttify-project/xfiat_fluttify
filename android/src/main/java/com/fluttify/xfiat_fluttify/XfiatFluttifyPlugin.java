...
public class XfiatFluttifyPlugin implements FlutterPlugin, MethodChannel.MethodCallHandler {
    ...
    private final Map<String, Handler> handlerMap = new HashMap<String, Handler>() {{
        ...
        // method
        put("com.iflytek.cloud.msc.util.FileUtil::saveFile__Uint8List__String__bool__int", (args, methodResult) -> {
            // args
            // jsonable arg
            byte[] var0 = (byte[]) args.get("var0");
            // jsonable arg
        ...
        // method
        put("com.iflytek.cloud.msc.util.FileUtil::saveFile__Uint8List__String", (args, methodResult) -> {
            // args
            // jsonable arg
            byte[] var0 = (byte[]) args.get("var0");
            // jsonable arg
            ...
            // print log
            if (getEnableLog()) {
                Log.d("fluttify-java", "fluttify-java: com.iflytek.cloud.msc.util.FileUtil::saveFile(" + var0 + var1 + ")");
            }
        
            // invoke native method
            boolean result;
            try {
                result = com.iflytek.cloud.msc.util.FileUtil.saveFile(var0, var1);
            } catch (Throwable throwable) {
                throwable.printStackTrace();
                if (getEnableLog()) {
                    Log.d("Current HEAP: ", getHEAP().toString());

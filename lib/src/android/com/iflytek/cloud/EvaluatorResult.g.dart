...
class com_iflytek_cloud_EvaluatorResult extends java_lang_Object with android_os_Parcelable {
  ...
  static Future<com_iflytek_cloud_EvaluatorResult> create__String(String var1) async {
    final int refId = await MethodChannel('com.fluttify/xfiat_fluttify').invokeMethod('ObjectFactory::createcom_iflytek_cloud_EvaluatorResult__String', {"var1": var1});
    final object = com_iflytek_cloud_EvaluatorResult()..refId = refId..tag = 'xfiat_fluttify';
  ...
  Future<String> getResultString() async {
    ...
    final result = await MethodChannel('com.fluttify/xfiat_fluttify').invokeMethod('com.iflytek.cloud.EvaluatorResult::getResultString', {"refId": refId});

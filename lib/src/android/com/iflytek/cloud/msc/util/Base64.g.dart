...
class com_iflytek_cloud_msc_util_Base64 extends java_lang_Object  {
  ...
  static Future<String> encode(Uint8List var0) async {
    ...
    final result = await MethodChannel('com.fluttify/xfiat_fluttify').invokeMethod('com.iflytek.cloud.msc.util.Base64::encode', {"var0": var0});
  ...
  static Future<Uint8List> decode(Uint8List var0) async {
    ...
    // invoke native method
    final result = await MethodChannel('com.fluttify/xfiat_fluttify').invokeMethod('com.iflytek.cloud.msc.util.Base64::decode', {"var0": var0});

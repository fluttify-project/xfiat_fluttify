...
class com_iflytek_cloud_speech_impl_SpeakerVerifierImpl extends java_lang_Object  {
  ...
  Future<int> startListening(com_iflytek_cloud_VerifierListener var1) async {
    ...
    final result = await MethodChannel('com.fluttify/xfiat_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeakerVerifierImpl::startListening', {"refId": refId});
        ...
        .setMethodCallHandler((methodCall) async {
          ...
          switch (methodCall.method) {
            ...
            case 'Callback::com.iflytek.cloud.VerifierListener::onResult':
              ...
              // handle the native call
              var1?.onResult(com_iflytek_cloud_VerifierResult()..refId = (args['var1'])..tag = 'xfiat_fluttify');
              break;
  ...
  Future<void> getPasswordList(com_iflytek_cloud_SpeechListener var1) async {
    ...
    // invoke native method
    final result = await MethodChannel('com.fluttify/xfiat_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeakerVerifierImpl::getPasswordList', {"refId": refId});
  ...
  Future<int> sendRequest(String var1, String var2, com_iflytek_cloud_SpeechListener var3) async {
    ...
    // invoke native method
    final result = await MethodChannel('com.fluttify/xfiat_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeakerVerifierImpl::sendRequest', {"var1": var1, "var2": var2, "refId": refId});

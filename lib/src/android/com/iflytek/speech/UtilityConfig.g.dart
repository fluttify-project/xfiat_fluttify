...
class com_iflytek_speech_UtilityConfig extends java_lang_Object  {
  ...
  static Future<com_iflytek_speech_UtilityConfig> create__() async {
    final int refId = await MethodChannel('com.fluttify/xfiat_fluttify').invokeMethod('ObjectFactory::createcom_iflytek_speech_UtilityConfig__');
    final object = com_iflytek_speech_UtilityConfig()..refId = refId..tag = 'xfiat_fluttify';
  ...
  static Future<String> getCallerInfo(android_content_Context var0, String var1) async {
    ...
    final result = await MethodChannel('com.fluttify/xfiat_fluttify').invokeMethod('com.iflytek.speech.UtilityConfig::getCallerInfo', {"var0": var0.refId, "var1": var1});
  ...
  static Future<String> getComponentUrlParam(android_content_Context var0) async {
    ...
    // invoke native method
    final result = await MethodChannel('com.fluttify/xfiat_fluttify').invokeMethod('com.iflytek.speech.UtilityConfig::getComponentUrlParam', {"var0": var0.refId});
